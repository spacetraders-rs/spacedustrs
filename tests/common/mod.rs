...
pub struct TestClient {
    pub http_client: Arc<Mutex<spacedustrs::client::SpaceTradersClient>>,
    pub client: spacedustrs::client::Client,
}
impl TestClient {
    pub fn new() -> Self {
        Self {
            http_client: spacedustrs::client::get_http_client(None),
            client: spacedustrs::client::Client::new(
                spacedustrs::client::get_http_client(None),
